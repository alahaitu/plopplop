...
public class TouchGesture
{
	...
	public IEnumerator CheckHorizontalSwipes(Action onLeftSwipe, Action onRightSwipe, Action onStationary) //Coroutine, which gets Started in "Start()" and runs over the whole game to check for swipes
	{
		while (true)
